...
const FilterDropdown = ({ options, selected, onSelect }: FilterDropdownProps) => (
  <DropdownMenu.Root>
    <DropdownMenu.Trigger asChild>
      <button
        className="relative flex items-center gap-2 border px-1 py-1 !bg-white rounded-md text-sm text-[#4B5563] font-medium !border-none !outline-none !focus:outline-none "
        type="button"
      >
